...
// Phase dashboard filters
export const phaseDashboardParsers = {
  // Selected phase for detailed view (e.g. ?selectedPhase=phase-id)
  selectedPhase: parseAsString.withDefault(""),
};

export const phaseDashboardSearchParamsCache = createSearchParamsCache(
  phaseDashboardParsers
);
