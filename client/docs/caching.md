if you can check the unchanged files of members phases page. The page shows the loading.tsx everytime I open the page. What I expected is after the initial load, the next time I open it again is it will open instantly. It feels slow if the skeletons are always showing

I'm using axios but nextjs docs didn't mentioned how to cache in axios
